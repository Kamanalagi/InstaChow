...
public class SeaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sea_food.add(new SeaClass("Finger Fish", " $2.00", R.drawable.fingerfish,"0"));
        sea_food.add(new SeaClass("Shrimp", " $3.00", R.drawable.shrimp,"0"));
        sea_food.add(new SeaClass("Fried Fish", " $10.00", R.drawable.fishone,"0"));
        sea_food.add(new SeaClass("Prawn Soup", " $9.00", R.drawable.prawnsoup,"0"));
