        ...
        cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(quantity != 0) { //if quan < 0 or equals to 0
                    if (pos == 0) {
                        boolean isinserted = mydb.Add_to_Cart("Finger Fish",String.valueOf(quantity),String.valueOf(2*quantity));
                        if (isinserted)
                        {
                            int price = 1; //price * quantity = total price
                            order_details[i] = "Id " + counter + " Finger Fish Price $" + 2 * quantity + " ";
                    ...
                    if (pos == 1) {
                        boolean isinserted =  mydb.Add_to_Cart("Shrimp",String.valueOf(quantity),String.valueOf(3*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Shrimp Price $" + 3 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 2) {
                        boolean isinserted = mydb.Add_to_Cart("Fried Fish",String.valueOf(quantity),String.valueOf(10*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id : " + counter + " Fried Fish Price $" + 10 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 3) {
                        ...
                        boolean isinserted = mydb.Add_to_Cart("Prawn Soup",String.valueOf(quantity),String.valueOf(9*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Prawn Soup Price $" + 9 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
