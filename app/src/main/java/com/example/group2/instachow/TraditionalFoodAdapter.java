        ...
        cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(quantity != 0) { //if quan < 0 or equals to 0
                    if (pos == 0) {
                        boolean isinserted = mydb.Add_to_Cart("Karahi",String.valueOf(quantity),String.valueOf(4*quantity));
                        if (isinserted)
                        {
                            int price = 1; //price * quantity = total price
                            order_details[i] = "Id " + counter + " Karahi Price $" + 4 * quantity + " ";
                    ...
                    if (pos == 1) {
                        boolean isinserted =  mydb.Add_to_Cart("Biryani",String.valueOf(quantity),String.valueOf(6*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Biryani Price $" + 6 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 2) {
                        boolean isinserted = mydb.Add_to_Cart("Malai Boti",String.valueOf(quantity),String.valueOf(4*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id : " + counter + " Malai Boti Price $" + 4 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 3) {
                        ...
                        boolean isinserted = mydb.Add_to_Cart("Seekh Kabab",String.valueOf(quantity),String.valueOf(4*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Seekh Kabab Price $" + 4 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 4) {
                        boolean isinserted =  mydb.Add_to_Cart("Tikka",String.valueOf(quantity),String.valueOf(5*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Tikka Price $" + 5 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
                    ...
                    if (pos == 5) {
                        boolean isinserted =  mydb.Add_to_Cart("Sajji",String.valueOf(quantity),String.valueOf(10*quantity));
                        if (isinserted)
                        {
                            int price = 1;
                            order_details[i] = "Id " + counter + " Sajji Price $" + 10 * quantity + " ";
                            counter++;
                            i++;
                            quantity = 0;
                            Toast.makeText(getContext(), "Order Added Successfully !", Toast.LENGTH_SHORT).show();
